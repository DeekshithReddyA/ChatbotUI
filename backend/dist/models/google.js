...
const ai = new genai_1.GoogleGenAI({ apiKey: googleAPIKEY });
function generateText(input) {
    return __asyncGenerator(this, arguments, function* generateText_1() {
        var _a, e_1, _b, _c;
        const response = yield __await(ai.models.generateContentStream({
        ...
        try {
            for (var _d = true, response_1 = __asyncValues(response), response_1_1; response_1_1 = yield __await(response_1.next()), _a = response_1_1.done, !_a; _d = true) {
                ...
                _d = false;
                const chunk = _c;
                yield yield __await(chunk.text); // yield, not return
            }
        }
