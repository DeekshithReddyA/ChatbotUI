...
exports.modifyLockedModels = exports.modifyPinnedModels = exports.models = void 0;
exports.models = [
    {
        id: "gemini-2.0-flash",
...
const modifyPinnedModels = (newModels) => {
    return exports.models.map((model) => {
        if (newModels.includes(model.id)) {
            return Object.assign(Object.assign({}, model), { isPinned: true });
        }
    });
};
exports.modifyPinnedModels = modifyPinnedModels;
const modifyLockedModels = (isProMember) => {
    return exports.models.map((model) => {
        if (isProMember) {
            return Object.assign(Object.assign({}, model), { isLocked: false });
        }
    });
};
exports.modifyLockedModels = modifyLockedModels;
